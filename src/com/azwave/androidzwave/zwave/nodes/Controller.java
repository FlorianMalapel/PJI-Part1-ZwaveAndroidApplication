...
public class Controller extends Node {
	...
	public Controller(int homeId, byte nodeId, QueueManager queue, XMLManager xml, Log log) {
	...
	public void requestNodeNeighbors(byte nodeId, int requestFlag) {
		if (isAPICallSupported(Defs.FUNC_ID_ZW_GET_ROUTING_INFO)) {
			Msg msg = new Msg(nodeId, Defs.REQUEST, Defs.FUNC_ID_ZW_GET_ROUTING_INFO, false);
