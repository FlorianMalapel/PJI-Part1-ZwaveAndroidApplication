...
public class QueueManager {
	...
	private byte transmitOptions = Defs.TRANSMIT_OPTION_ACK | Defs.TRANSMIT_OPTION_AUTO_ROUTE | Defs.TRANSMIT_OPTION_EXPLORE;
	...
	public QueueManager(Log log) {
		queue = new PriorityBlockingQueue <QueueItem> (13, new QueueItemComparator());
		logs = log;
	}
	...
	public void sendMsg(Msg msg, QueuePriority priority) {
		...
		logs.add("Q: [Send Messg] " + msg.toString());
		queue.add(item);
	}
