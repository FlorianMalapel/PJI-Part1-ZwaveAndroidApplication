...
public class Msg {
	...
	public static final byte MULTI_CHANNEL = 0x01; // Indicate MultiChannel encapsulation
	public static final byte MULTI_INSTANCE = 0x02; // Indicate MultiInstance encapsulation
	...
	public Msg(byte nodeId, byte type, byte function, boolean callbackRequired, boolean replyRequired) {
	...
	public static Msg createZWaveMemoryGetId(byte nodeId) {
		return new Msg(nodeId, Defs.REQUEST, Defs.FUNC_ID_ZW_MEMORY_GET_ID, false);
	}

	public static Msg createZWaveGetControllerCapabilities(byte nodeId) {
		return new Msg(nodeId, Defs.REQUEST, Defs.FUNC_ID_ZW_GET_CONTROLLER_CAPABILITIES, false);
	}

	public static Msg createZWaveSerialAPIGetCapabilities(byte nodeId) {
		return new Msg(nodeId, Defs.REQUEST,  Defs.FUNC_ID_SERIAL_API_GET_CAPABILITIES, false);
	}

	public static Msg createZWaveGetSUCNodeId(byte nodeId) {
		return new Msg(nodeId, Defs.REQUEST, Defs.FUNC_ID_ZW_GET_SUC_NODE_ID, false);
	}
